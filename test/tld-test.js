...
vows
    .describe('TLD and SLD validation')
    .addBatch(createBatch('tld', true, [
        'ac',
        'com.ac',
        'edu.ac',
        'gov.ac',
        ...
        'yamaguchi.jp',
        'yamanashi.jp',
        'anything.kawasaki.jp',
        'anything.kitakyushu.jp',
        'anything.kobe.jp',
        'anything.nagoya.jp',
        'anything.sapporo.jp',
        'anything.sendai.jp',
        'anything.yokohama.jp',
        'aisai.aichi.jp',
        'ama.aichi.jp',
        'anjo.aichi.jp',
        'asuke.aichi.jp',
    ...
    .addBatch(createBatch('tld', false, [
